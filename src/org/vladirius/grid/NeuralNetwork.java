...
public class NeuralNetwork {
	...
	public static void CreateTrainingData() {
		...
		float[] expectedOutpout1 = new float[] {0};
		float[] expectedOutpout2 = new float[] {1};
		float[] expectedOutpout3 = new float[] {1};
		float[] expectedOutpout4 = new float[] {0};
		
		// using an array for the data sets
		tDataSet = new TrainingData[4];
		tDataSet[0] = new TrainingData(input1, expectedOutpout1);
		tDataSet[1] = new TrainingData(input2, expectedOutpout2);
		tDataSet[2] = new TrainingData(input3, expectedOutpout3);
		tDataSet[3] = new TrainingData(input4, expectedOutpout4);
	}
	...
	public static void backward(float learning_rate, TrainingData tdata) {
		...
		// Here we do anpther pass where we update all the weights
	...
	public static void train(int traing_iteration, float learning_rate) {
		for (int i = 0; i < traing_iteration; i++) {
